Particles=
{
    ...
    positionBase   : new THREE.Vector3( -60, 150,  -50 ),
    positionSpread : new THREE.Vector3(    0,  100, 300 ),
    
    velocityStyle  : Type.CUBE,
    velocityBase   : new THREE.Vector3( 40, 0, 0 ),
    velocitySpread : new THREE.Vector3( 20, 0, 0 ), 
    
    particleTexture : THREE.ImageUtils.loadTexture( 'assets/textures/general/clouds.png'),
